...
//        posts.add(new Rating(R.mipmap.ic_launcher, "Jasper Pillejera", "Remedios de Dios Bulos", "ST-STAT", 3.0, 53, 2, 3.0f));
        for(int i = 0; i < reviewsList.size(); i++){
            ...
            posts.add(new Rating(R.mipmap.ic_launcher, student.getFirst_name()+ " " + student.getLast_name(), faculty.getFirst_name() + " " + faculty.getLast_name(), "OPERSYS", reviewsList.get(i).getGrade(), reviewsList.get(i).getUpvotes(), reviewsList.get(i).getDownvotes(), reviewsList.get(i).getRating()));

            posts.add(new PostReview(R.mipmap.ic_launcher, student.getFirst_name()+ " " + student.getLast_name(), faculty.getFirst_name() + " " + faculty.getLast_name(), "OPERSYS", reviewsList.get(i).getGrade(), reviewsList.get(i).getUpvotes(), reviewsList.get(i).getDownvotes(), reviewsList.get(i).getReview()));
